...
// const storedXp = parseInt(localStorage.getItem(`${storedCategory}-xp`)); // Get stored category directly as a string

if (storedCategory == "Physical") {
  addXP("Physical", 10);
  something = null;
} else if (storedCategory== "Academic") {
  addXP("Academic", 10);
  something = null;
} else if (storedCategory== "Spiritual") {
  addXP("Spiritual", 10);
  something = null;
}
